...
public class FizzBuzzTest {
    public static void main(String[] args){
        ...
        System.out.println(Asserts.assertEquals(FizzBuzz.fizzBuzz(25), "Buzz"));
        System.out.println(Asserts.assertEquals(FizzBuzz.fizzBuzz(1000), "Buzz"));
        ...
        System.out.println(Asserts.assertNotEquals(FizzBuzz.fizzBuzz(10), "FizzBuzz"));
